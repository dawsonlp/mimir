...
class TestGraphScopedSearch:
    ...
    async def test_graph_scope_deeper_depth(self, async_client: AsyncClient, search_graph):
    ...
    async def test_graph_scope_with_relation_filter(self, async_client: AsyncClient, search_graph):
    ...
    async def test_graph_scope_outgoing_direction(self, async_client: AsyncClient, search_graph):
...
class TestScopeArtifactIdCompat:
    ...
    async def test_scope_artifact_id_works(self, async_client: AsyncClient, search_graph):
...
class TestGraphScopeValidation:
    ...
    async def test_graph_scope_invalid_direction(self, async_client: AsyncClient, search_graph):
    ...
    async def test_graph_scope_invalid_depth(self, async_client: AsyncClient, search_graph):
