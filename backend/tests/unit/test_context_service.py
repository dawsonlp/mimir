...
class TestTemporalFilter:
    ...
    def test_historical_mode_filters_recent(
        self, artifacts_with_dates: list[ContextArtifact]
    ):
    ...
    def test_range_mode_filters_outside_range(
        self, artifacts_with_dates: list[ContextArtifact]
    ):
    ...
    def test_no_days_back_returns_all(
        self, artifacts_with_dates: list[ContextArtifact]
    ):
...
class TestApplyHints:
    ...
    @pytest.mark.asyncio
    async def test_no_hints_returns_all(
        self, sample_context_artifacts: list[ContextArtifact]
    ):
    ...
    @pytest.mark.asyncio
    async def test_token_budget_limits_results(
        self, sample_context_artifacts: list[ContextArtifact]
    ):
    ...
    @pytest.mark.asyncio
    async def test_temporal_filter_applied(
        self, sample_context_artifacts: list[ContextArtifact]
    ):
